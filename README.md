...
- 🚀 **[any-llm](https://github.com/njbrake/any-llm)** - Talk to any llm or provider with a simple interface
- 🤖 **[any-agent](https://github.com/njbrake/any-agent)** - One interface for a bunch of different agent frameworks
